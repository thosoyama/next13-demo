...
import { Card } from '~/features/common/components/parts/card'
    ...
    <div className={styles.root}>
      <main className="flex min-h-screen flex-col items-center justify-between p-24">
        ...
        <div className="mb-32 grid text-center lg:mb-0 lg:grid-cols-4 lg:text-left">
          <Card title="React" href="/react/use/transition">
            Find in-depth information about Next.js features and API.
          </Card>
          <Card title="Omikuji" href="/game/omikuji">
            Learn about Next.js in an interactive course with&nbsp;quizzes!
          </Card>
          <Card title="Sanmokunarabe" href="/game/sanmokunarabe">
            Explore the Next.js 13 playground.
          </Card>
          <Card title="Reversi" href="/game/reversi">
            Instantly deploy your Next.js site to a shareable URL with Vercel.
          </Card>
          <Card title="Tetris" href="/game/tetris">
            Instantly deploy your Next.js site to a shareable URL with Vercel.
          </Card>
        </div>
      </main>
